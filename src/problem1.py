...
def run_test_problem1a():
    ...
    # Test 4:
    expected = .84147  # This is APPROXIMATELY the correct answer.
...
def run_test_problem1b():
    ...
    print("Test 1")
    print("expected: 5")
    print("actual:", problem1b(3,5))

    print("Test 2")
    print("expected: 1")
    print("actual:", problem1b(2, 1))

    print("Test 3")
    print("expected: 44")
    print("actual:", problem1b(5, 40))

    print("Test 4")
    print("expected: 2")
    print("actual:", problem1b(2, 2))
